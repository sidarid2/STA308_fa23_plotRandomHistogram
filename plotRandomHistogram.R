...
#*    mu = the theoretical mean of the Normal distribution that generates
#*         my data
#*    sigma = the theoretical standard deviation
#*    seed = an optional random number generator seed value, defaults to NULL
#*    meanColor = the color of the line corresponding to the sample mean of
#*                the data
#*    
#* Output:
...
#*       Mean_Random_obs = sample mean corresponding to the randomly
#*                         generated data
...
plotRandomHistogram <- function(num_pts = 30, mu=0, sigma=1, seed=NULL,
  ...
  ## In R, in a function, the output from the last line is
